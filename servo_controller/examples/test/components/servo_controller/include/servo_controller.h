...
/**
 * @brief Used to test the pcb board by setting servo control pins. 
 *        The pins should alternate between high and low or 5v and 0v.
 * @note Can be tested without the board using a oscilliscope, check github for expected image.
 * 
 * @param[in]   handle      Handle for the servo controller
 * 
 * @return
 *      - ESP_ERR_INVALID_ARG       The input handle is invalid.
 *      - ESP_ERR_INVALID_STATE     The servo controller has been started.
 *      - ESP_OK                    The pins have now been set.
 */
